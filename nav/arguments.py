...
def get_args():
    ...
    parser.add_argument('--map_trad_detection_threshold', type=float, default=0.99)
    ...
    parser.add_argument("--semantic_frontiers",action= 'store_true')
    ...
    # args for height estimation
    parser.add_argument('--estimate_z', type = int, default = 0)
